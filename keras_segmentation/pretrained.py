...
def resnet_pspnet_VOC12_v0_1(framework='keras'):
...
def pspnet_50_ADE_20K(framework='keras'):
...
def pspnet_101_cityscapes(framework='keras'):
...
def pspnet_101_voc12(framework='keras'):
